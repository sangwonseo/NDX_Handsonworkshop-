...
다음으로 Trident 구성을 진행합니다. NKS HCI에는 기본으로 Trident 19.04.1 버전의 패키지가 다운로드 되어 있습니다. 만약 최신 버전(19.07)의 Trident를 사그렇지 않으면, 다시 다운로드하여 설치 하여도 됩니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTU5NzMwOTUsMTIzOTA3MjkyNywtMT
